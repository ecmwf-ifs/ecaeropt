...
! +----------------------------------------------------------------------------------------+
     ...
     DO IRH=1,rh_int
        ...
        DO Nwv=1,nb_lambda
           ...
           DO dbin=0, Nbin_points 
              ...
              call mie_core_phase(Nsize, Nmax, Nmumax, x, a, b, ph_ang, Q_sca, phase, pi, F11, F12, F33, F34)
              ...
              ! Here we have to think about how to calculate the Fij as probably
              ! there are integrales over dr like PP is an integral of phase()
              ! all of them have the same normalization so 
  ...
  subroutine mie_core_phase(Nsize, Nmax, Nmumax,x, a,b, ph_ang, Q_sca, phase, pi, F11, F12, F33, F34)
    ...
    real(8)       , INTENT(INOUT)  :: F11(1:Nmumax)
    real(8)       , INTENT(INOUT)  :: F12(1:Nmumax)
    real(8)       , INTENT(INOUT)  :: F33(1:Nmumax)
